...
DS_MEMORY_SEARCH = _schema("ds_memory_search", "Search DeepScientist global/quest memory cards.", {"query": S["query"], "quest_id": S["quest_id"], "scope": S["scope"], "kind": S["kind"], "limit": S["limit"]}, ["query"])
...
DS_MEMORY_WRITE = _schema("ds_memory_write", "Write a DeepScientist memory card.", {"title": S["title"], "content": S["content"], "body": S["body"], "markdown": {"type": "string"}, "quest_id": S["quest_id"], "scope": S["scope"], "kind": S["kind"], "tags": {"type": "array", "items": {"type": "string"}}, "metadata": {"type": "object"}}, ["title"])
...
DS_SUBMIT_PAPER_OUTLINE = _schema("ds_submit_paper_outline", "Submit/select/revise a paper outline.", {"quest_id": S["quest_id"], "mode": {"type": "string"}, "outline_id": {"type": "string"}, "title": S["title"], "note": {"type": "string"}, "story": {"type": "string"}, "ten_questions": {"type": "array"}, "detailed_outline": {"type": "object"}}, ["quest_id"])
...
DS_BASH_EXEC = _schema("ds_bash_exec", "Run/list/read/wait/stop quest-local bash execution sessions natively.", {"quest_id": S["quest_id"], "command": S["command"], "operation": {"type": "string", "enum": ["run", "list", "status", "read", "wait", "stop"]}, "bash_id": {"type": "string"}, "workdir": {"type": "string"}, "timeout_seconds": {"type": "integer"}, "wait": {"type": "boolean"}, "limit": S["limit"]})
...
NATIVE_SCHEMAS = [
    ...
    DS_ATTACH_BASELINE, DS_SUBMIT_IDEA, DS_LIST_RESEARCH_BRANCHES, DS_RECORD_MAIN_EXPERIMENT,
    DS_CREATE_ANALYSIS_CAMPAIGN, DS_RECORD_ANALYSIS_SLICE, DS_SUBMIT_PAPER_OUTLINE,
