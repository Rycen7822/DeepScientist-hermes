...
- Keep ordinary subtask completions concise. When a paper/draft milestone is actually completed, upgrade to a richer `artifact.record(payload={'kind': 'milestone'}, reply_mode='threaded', ...)` report instead of another short progress update.
